...
pub struct Params {
    ...
    pub spot_market_instant_listing_fee: ::core::option::Option<super::super::super::super::cosmos::base::v1beta1::Coin>,
    ...
    pub derivative_market_instant_listing_fee: ::core::option::Option<super::super::super::super::cosmos::base::v1beta1::Coin>,
    ...
    pub binary_options_market_instant_listing_fee: ::core::option::Option<super::super::super::super::cosmos::base::v1beta1::Coin>,
}
...
pub struct DerivativeMarket {
    ...
    /// Oracle type
    #[prost(enumeration="super::super::super::oracle::v1beta1::OracleType", tag="4")]
    pub oracle_type: i32,
...
pub struct DerivativeMarketSettlementInfo {
    ...
    #[prost(string, tag="3")]
    pub starting_deficit: ::prost::alloc::string::String,
}
#[derive(serde::Serialize, serde::Deserialize)]
#[derive(Clone, PartialEq, ::prost::Message)]
...
pub struct CampaignRewardPool {
    ...
    #[prost(message, repeated, tag="2")]
    pub max_campaign_rewards: ::prost::alloc::vec::Vec<super::super::super::super::cosmos::base::v1beta1::Coin>,
}
#[derive(serde::Serialize, serde::Deserialize)]
#[derive(Clone, PartialEq, ::prost::Message)]
...
pub struct AccountRewards {
    ...
    #[prost(message, repeated, tag="2")]
    pub rewards: ::prost::alloc::vec::Vec<super::super::super::super::cosmos::base::v1beta1::Coin>,
}
#[derive(serde::Serialize, serde::Deserialize)]
#[derive(Clone, PartialEq, ::prost::Message)]
...
pub struct MsgInstantPerpetualMarketLaunch {
    ...
    pub oracle_scale_factor: u32,
    /// Oracle type
    #[prost(enumeration="super::super::super::oracle::v1beta1::OracleType", tag="7")]
    pub oracle_type: i32,
...
pub struct MsgInstantBinaryOptionsMarketLaunch {
    ...
    pub oracle_provider: ::prost::alloc::string::String,
    /// Oracle type
    #[prost(enumeration="super::super::super::oracle::v1beta1::OracleType", tag="5")]
    pub oracle_type: i32,
    /// Scale factor for oracle prices.
    #[prost(uint32, tag="6")]
    pub oracle_scale_factor: u32,
...
pub struct MsgInstantExpiryFuturesMarketLaunch {
    ...
    pub oracle_quote: ::prost::alloc::string::String,
    /// Oracle type
    #[prost(enumeration="super::super::super::oracle::v1beta1::OracleType", tag="6")]
    pub oracle_type: i32,
    /// Scale factor for oracle prices.
    #[prost(uint32, tag="7")]
    pub oracle_scale_factor: u32,
...
pub struct MsgExec {
    ...
    #[prost(message, repeated, tag="2")]
    pub bank_funds: ::prost::alloc::vec::Vec<super::super::super::super::cosmos::base::v1beta1::Coin>,
    /// deposits_subaccount_id defines the user's subaccountID to fund the execution
    #[prost(string, tag="3")]
    pub deposits_subaccount_id: ::prost::alloc::string::String,
    /// deposit_funds defines the fund amounts to fund the execution
    #[prost(message, repeated, tag="4")]
    pub deposit_funds: ::prost::alloc::vec::Vec<super::super::super::super::cosmos::base::v1beta1::Coin>,
...
pub struct PerpetualMarketLaunchProposal {
    ...
    pub oracle_scale_factor: u32,
    /// Oracle type
    #[prost(enumeration="super::super::super::oracle::v1beta1::OracleType", tag="8")]
    pub oracle_type: i32,
    /// initial_margin_ratio defines the initial margin ratio for the derivative market
    #[prost(string, tag="9")]
    pub initial_margin_ratio: ::prost::alloc::string::String,
...
pub struct BatchCommunityPoolSpendProposal {
    ...
    pub description: ::prost::alloc::string::String,
    #[prost(message, repeated, tag="3")]
    pub proposals: ::prost::alloc::vec::Vec<super::super::super::super::cosmos::distribution::v1beta1::CommunityPoolSpendProposal>,
}
...
pub struct QuerySpotOrderbookResponse {
    #[prost(message, repeated, tag="1")]
    pub buys_price_level: ::prost::alloc::vec::Vec<PriceLevel>,
    #[prost(message, repeated, tag="2")]
    pub sells_price_level: ::prost::alloc::vec::Vec<PriceLevel>,
}
...
pub mod full_derivative_market {
    ...
    pub enum Info {
        #[prost(message, tag="2")]
        PerpetualInfo(super::super::PerpetualMarketState),
        #[prost(message, tag="3")]
        FuturesInfo(super::super::ExpiryFuturesMarketInfo),
    }
}
...
pub struct QueryMarketVolatilityResponse {
    ...
    #[prost(message, optional, tag="2")]
    pub history_metadata: ::core::option::Option<super::super::super::oracle::v1beta1::MetadataStatistics>,
    #[prost(message, repeated, tag="3")]
