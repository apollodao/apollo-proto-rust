...
pub struct Input {
    ...
    pub coins: ::prost::alloc::vec::Vec<super::super::super::base::v1beta1::Coin>,
}
...
pub struct Supply {
    #[prost(message, repeated, tag = "1")]
    pub total: ::prost::alloc::vec::Vec<super::super::super::base::v1beta1::Coin>,
}
...
pub struct QueryBalanceResponse {
    ...
    pub balance: ::core::option::Option<super::super::super::base::v1beta1::Coin>,
}
...
pub struct QueryAllBalancesResponse {
    ...
    #[prost(message, repeated, tag = "1")]
    pub balances: ::prost::alloc::vec::Vec<super::super::super::base::v1beta1::Coin>,
...
pub struct QueryTotalSupplyResponse {
    ...
    #[prost(message, repeated, tag = "1")]
    pub supply: ::prost::alloc::vec::Vec<super::super::super::base::v1beta1::Coin>,
    /// pagination defines the pagination in the response.
    ///
    /// Since: cosmos-sdk 0.43
    #[prost(message, optional, tag = "2")]
...
pub struct QuerySupplyOfResponse {
    ...
    #[prost(message, optional, tag = "1")]
    pub amount: ::core::option::Option<super::super::super::base::v1beta1::Coin>,
}
